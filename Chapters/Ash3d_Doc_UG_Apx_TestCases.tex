...
To test that a build of Ash3d is calculating correctly, a quick check is to
...
such as: CFL value, minimum/maximum \texttt{dt}, 
...
\subsubsection{4.5 1-D winds, Topography (Z\_ID=0)}
\subsubsection{4.6 1-D winds, Topography (Z\_ID=1)}
\subsubsection{4.7 1-D winds, Topography (Z\_ID=2)}
