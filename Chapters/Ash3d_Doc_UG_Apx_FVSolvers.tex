...
\end{equation}
as suggested by
Eq 9.39 of \cite{LeVeque03} so that the cell-centered flux values are an approximation of
...
The higher order terms of Eq \ref{EqQupdate} above are given by Eq. 6.60 of \cite{LeVeque03}.
