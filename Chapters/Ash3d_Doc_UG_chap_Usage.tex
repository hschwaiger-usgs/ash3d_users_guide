...
and may be appropriate for some VEI 4 or 5 eruptions \cite{Mastin2020}. Source
...
Equations (2) and (3) of \cite{Costa2013}, and is proportional to the mass
eruption rate.
...
\subsection{Extensions to the control file: Optional Modules}\label{ChapUsage_SS_OptMod}
